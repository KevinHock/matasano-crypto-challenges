...
# Note that you'll need to write your own modexp (this is blackboard math, don't freak out), because you'll blow out your bignum library raising "a" to 
# the 1024-bit-numberth power. You can find modexp routines on Rosetta Code for most languages.
...
a = random.randrange(37)
capitlal_A = (g**a) % p
b = random.randrange(37)
capitlal_B = (g**b) % p

s = (capitlal_B**a) % p # or (capitlal_A**b) % p
